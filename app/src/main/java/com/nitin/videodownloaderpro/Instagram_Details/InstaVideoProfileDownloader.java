...
public class InstaVideoProfileDownloader extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insta_video_profile_downloader);
        ...
        pyFunction = py.getModule("InstaPostDownloader").get("download_video");
                ...
                if (downloadedPosts != null && !downloadedPosts.isEmpty()) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            PostAdapter postAdapter = new PostAdapter(InstaVideoProfileDownloader.this, postsList);
